...
CKPT="/workspace/checkpoints/eagle3/gpt-oss-120b/epoch_6_step_12000"
...
python bench_eagle3.py \
    ...
    --tp 1 \
    --output-dir /workspace/checkpoints/eagle3/gpt-oss-120b/bench_results
