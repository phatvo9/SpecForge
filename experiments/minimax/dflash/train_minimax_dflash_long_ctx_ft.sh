...
# MiniMax-M2.7 DFlash long-ctx finetune
# Init from long-ctx pretrain epoch2 step 280k
# Finetune with synthesis_25k data, constant LR

export ROCR_VISIBLE_DEVICES=0,3,4,6
...
torchrun \
    ...
    --draft-config-path /workspace/checkpoints/dflash/minimax-m2.7-long-ctx-ft/epoch_0_step_0/config.json \
    ...
    --output-dir /workspace/checkpoints/dflash/minimax-m2.7-long-ctx-ft/ \
    --tp-size $TP_SIZE \
