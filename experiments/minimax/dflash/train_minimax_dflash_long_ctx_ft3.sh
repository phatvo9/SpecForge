...
# MiniMax-M2.7 DFlash long-ctx ft3
...
torchrun \
    ...
    --draft-config-path /workspace/checkpoints/dflash/minimax-m2.7-long-ctx-ft3/epoch_0_step_0/config.json \
    ...
    --output-dir /workspace/checkpoints/dflash/minimax-m2.7-long-ctx-ft3/ \
    --tp-size $TP_SIZE \
    --target-model-backend sglang \
    --sglang-attention-backend aiter \
    --sglang-mem-fraction-static 0.9 \
    --sglang-context-length 22000 \
    --sglang-max-total-tokens 22000 \
    --trust-remote-code \
    --num-epochs 2 \
    --batch-size 1 \
