...
sys.argv[0] = "/workspace/SpecForge/experiments/minimax/dflash/eval_per_position.py"
runpy.run_path("/workspace/SpecForge/experiments/minimax/dflash/eval_per_position.py", run_name="__main__")
