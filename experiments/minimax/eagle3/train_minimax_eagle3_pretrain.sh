...
# MiniMax-M2.7 EAGLE3 Pretraining
# Following M2.5-Eagle3 recipe: 9 epochs on 54K mixed data
...
torchrun \
    ...
    --resume \
    --train-data-path /workspace/data/minimax2.7-spec-data/pretrain.jsonl \
    --build-dataset-num-proc 16 \
    --output-dir /workspace/checkpoints/minimax-m2.7-eagle3-pretrain-v2/ \
    --tp-size $TP_SIZE \
